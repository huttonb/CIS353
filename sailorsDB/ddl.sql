...
*/
CONSTRAINT IC1 CHECK (rank = 'DB guru' OR rank = 'DB expert' OR rank = 'DB rookie'),
/*
IC2: The salary of a 'DB guru' is above 200.
*/
CONSTRAINT IC2 CHECK (NOT ( rank = 'DB guru' AND salary <= 200)),
/*
IC3: The salary of a 'DB expert' is between 80 and 220 (inclusive).
*/
CONSTRAINT IC3 CHECK (NOT (rank = 'DB expert' AND (salary > 220 OR salary < 80))),
/*
IC4: The salary of a 'DB rookie' is less than 100.
*/
CONSTRAINT IC4 CHECK (NOT (rank = 'DB rookie' AND salary >= 100))
);
--
--
